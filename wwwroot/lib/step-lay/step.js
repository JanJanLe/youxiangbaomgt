layui.define(['layer', 'carousel'], function (exports) {
    ...
    var renderDom = function (elem, stepItems, postion) {
        ...
        var contentwidth = $("[carousel-item]").width();
        var contentitemwidth = $(".step-item-content").width();
        var maginLeft = (contentwidth - contentitemwidth) / 2;
        $('.step-item-content').css('margin-left', maginLeft + 'px');
    ...
    var step = {
        ...
        render: function (param) {
            ...
            $("[carousel-item]").css('width', param.width);
            $('.step-item-content').css('width', param.stepWidth);
