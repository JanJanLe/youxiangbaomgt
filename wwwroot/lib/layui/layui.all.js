...
layui.define(["layer", "form"], function (t) {
	...
	var s = function (t, i, a) {
		...
		n.css({
			...
			var o = n.contents(),
				...
				s = e(["<style>", "*{margin: 0; padding: 0;}",
					...
					"img{display: inline-block; border: none; vertical-align: middle;max-width: 100%;border-radius: 5px;margin: 5px 0;}",
						...
						layui.use("upload", function (o) {
							...
							window.uni.chooseImage({
								...
								success(res) {
									...
									window.$Cloud.uploadFile({
										filePath: filePath,
										success: function (res) {
											console.log(res)
											res.success ? v.call(t, "img", {
												src: res.fileID,
												alt: "iTool"
											}, a) : i.msg(res.msg || "上传失败");
										}
									});
								}
							});
		...
		C = {
			...
			image: '<i class="layui-icon layedit-tool-image" title="图片" layedit-event="image">&#xe64a;<input type="file1" name="file"></i>',
